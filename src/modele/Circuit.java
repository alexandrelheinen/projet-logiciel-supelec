...
public class Circuit extends Observable {
	...
	public static final float posIni[][][] = {	{{147, 290},{75, 340},{147, 390},{75, 440}},
												...
												{{147, 290},{75, 340},{147, 390},{75, 440}},
												{{147, 290},{75, 340},{147, 390},{75, 440}}}; // p. ex.: posIni[n][m][0] donne la coordonnee x de la m-eme voiture dans le circuit n
	...
	// sortie = 1, si la voiture est e l'interieur du circuit
	public void testerLimites (Voiture voiture) {
		...
		try {
			...
			System.out.println("La voiture est sortie de la fenetre!");
	...
	public int getPiece(Voiture voiture) {
		// ce sont les coordonnees de la voiture pour les composants du circuit
		int[] posV = getCoordonates(voiture);
