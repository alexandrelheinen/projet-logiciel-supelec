...
public abstract class Controleur {
	...
	protected Voiture voiture;	// quelle est la voiture que le controleur contrele
	...
	public Controleur(int modele, int posIni, GameFrame frame, Circuit circuit) {
		...
		System.out.println("Voiture creee : Modele "+Integer.toString(modele)+"; Position initiale "+Integer.toString(posIni));
	...
	// mettre e jour la voiture, en appliquant la physique
